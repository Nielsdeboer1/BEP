...
stall_current = 0.54; %A
terminal_resistance = nominal_voltage/stall_current; %Ohm
resistance = 200; %Ohm

turbine_torque_netto = turbine_torque;

i = turbine_torque_netto / k_t_motor; %A
r_tot = terminal_resistance + resistance; %Ohm
...
DC_power = 1000*back_emf^2/(resistance + terminal_resistance);
